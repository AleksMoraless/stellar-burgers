...
import { fetchOrderByNumberThunk } from '../../services/thunks/fetchOrderByNumber';
...
export const OrderInfo: FC = () => {
  ...
  const ingredients: TIngredient[] = useSelector(store => ingredientsSelectors.getIngredientsSelector(store));
